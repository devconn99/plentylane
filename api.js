...
export default {
  auth: {
    signUp(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/auth/signup`;
      return axios
        .post(endpoint, data)
        .then((res) => {
    ...
    resetPasswordRequest(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/auth/reset-password-request`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    resetPassword(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/auth/reset-password`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
  ...
  dashboard: {
    profile: {
      ...
      updateShippingAddress(data) {
        const endpoint = `${process.env.API_ORIGIN}/api/users/update-shipping-address`;
        return axios
          .put(endpoint, data)
          .then((res) => {
            return Promise.resolve(res.data || {});
    ...
    meals: {
      addMeal(data) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/meals`;
        let _request;
        if (data["images"]) {
          const _config = {
            headers: {
      ...
      updateMeal(mealId, data) {
        ...
        const endpoint = `${process.env.API_ORIGIN}/api/me/meals/${mealId}`;
        if (data["images"]) {
          delete data["images"];
        }
        return axios
      ...
      getMyMealById(id, shouldJoinQuestions) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/meals/${id}?join=images`;
      ...
      getMyMeals(page) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/meals?join=images&join=offers&join=offers.ratings`;
        if (page) {
          endpoint += `&page=${page}`;
        }
        return axios
      ...
      searchMyMeals(name) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/meals?join=images`;
        if (name && name.length) {
      ...
      removeMyMeal(id) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/meals/${id}`;
        return axios
          .delete(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      removeImage(id) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/mealImages/${id}`;
        return axios
          .delete(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      getMealQuestions(mealId, showOnlyAnswered) {
        const endpoint = `${process.env.API_ORIGIN}/api/meals/${mealId}?join=mealQuestions&join=mealQuestions.askedBy&join=mealQuestions.askedBy.image`;
        return axios
          .get(endpoint)
          .then((res) => {
      ...
      getMyMealQuestions(mealId) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/meals/${mealId}?join=mealQuestions&join=mealQuestions.askedBy&join=mealQuestions.askedBy.image`;
        return axios
          .get(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      getMealById(id, shouldJoinQuestions) {
        let endpoint = `${process.env.API_ORIGIN}/api/meals/${id}?join=images`;
        if (shouldJoinQuestions) {
          endpoint +=
            "&join=mealQuestions&join=mealQuestions.askedBy&join=mealQuestions.askedBy.image";
        }
      ...
      contactCookByMealId(mealId, data) {
        const endpoint = `${process.env.API_ORIGIN}/api/meals/${mealId}/contact`;
        return axios
          .post(endpoint, data)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      cookAnswerByMealId(mealId, data) {
        const endpoint = `${process.env.API_ORIGIN}/api/meals/${mealId}/post-answer`;
        return axios
          .post(endpoint, data)
          .then((res) => {
            return Promise.resolve(res.data || {});
    ...
    places: {
      getPlaces() {
        const endpoint = `${process.env.API_ORIGIN}/api/places`;
        return axios
          .get(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      getPlacesByLocation(query) {
        let endpoint = `${process.env.API_ORIGIN}/api/places`;
        let _queryStr = "";
      ...
      getMyPlaces(limit) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/places`;
        if (limit) {
      ...
      getPlaceInfo(placeId) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/places/${placeId}`;
        return axios
          .get(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      addPlace(data) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/places`;
        return axios
          .post(endpoint, data)
          .then((res) => {
            return Promise.resolve(res.data || {});
    ...
    offers: {
      ...
      getMyOffers(shouldHidePastOffers, isPickupTimeSortingAsc = true, page) {
        // no need to add join=meal.images
        let endpoint = `${process.env.API_ORIGIN}/api/me/offers?join=place&join=meal`;
      ...
      getOfferById(id) {
        // no need to add join=meal.images
        const endpoint = `${process.env.API_ORIGIN}/api/offers/${id}?join=meal&join=place&join=user`;
        return axios
          .get(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      addOffer(data) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/offers`;
        return axios
          .post(endpoint, data)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      getMyOfferById(id) {
        // no need to add join=meal.images
        const endpoint = `${process.env.API_ORIGIN}/api/me/offers/${id}?join=place&join=meal`;
        return axios
          .get(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      removeOffer(id) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/offers/cancel/${id}`;
        return axios
          .delete(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      updateOffer(id, data) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/offers/update/${id}`;
        return axios
          .patch(endpoint, data)
          .then((res) => {
            return Promise.resolve(res.data || {});
    ...
    bookings: {
      postDine(data) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/bookings/dine`;
        return axios
          .post(endpoint, data)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      deleteDine(id) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/bookings/dine/${id}`;
        return axios
          .delete(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      getMyDines(
        ...
        // no need to add join=meal.images
        let endpoint = `${process.env.API_ORIGIN}/api/me/bookings/dine`;
      ...
      getMyCooks() {
        const endpoint = `${process.env.API_ORIGIN}/api/me/bookings/cook`;
        return axios
          .get(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
    ...
    users: {
      getUserInfo(id) {
        const endpoint = `${process.env.API_ORIGIN}/api/users/${id}?join=image`;
        return axios
          .get(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      getAllUsers(page, search, exceptionId) {
        let endpoint = `${process.env.API_ORIGIN}/api/users`;
    ...
    follows: {
      ...
      getMyFavorites(page, search) {
        ...
        // let endpoint = `${process.env.API_ORIGIN}/api/me/follows?filter=connectionType||$eq||favorite`;
        // const filterByUserName =
      ...
      searchConnections(page, search, type) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/follows/get-followers?connectionType=${type}`;
      ...
      getUserConnection(id) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/follows/`;
      ...
      getUserFriends(id) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/follows/get-friends/${id}`;
        return axios
          .get(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || []);
      ...
      followUser(id) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/follows`;
        return axios
          .post(endpoint, {
      ...
      unFollowUser(id) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/follows/${id}/friend`;
        return axios
          .delete(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      removeUserFromFavorites(id) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/follows/${id}/favorite`;
        return axios
          .delete(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
    ...
    mealQuestions: {
      postQuestion(data) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/mealQuestions/ask`;
        return axios
          .post(endpoint, data)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      getMyAnsweredQuestions(page) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/mealQuestions/ask?filter=answer||$notnull&sort=mealId,ASC&sort=createdAt,DESC`;
        if (page) {
          endpoint += `&page=${page}`;
        }
        return axios
      ...
      getMyUnAnsweredQuestions(page) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/mealQuestions/ask?filter=answer||$isnull&sort=mealId,ASC&sort=createdAt,DESC`;
        if (page) {
          endpoint += `&page=${page}`;
        }
        return axios
      ...
      getMyQuestionById(id) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/mealQuestions/ask/${id}`;
        return axios
          .get(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
      ...
      getUnAnsweredQuestionsForCook(page) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/mealQuestions/answer?filter=answer||$isnull&sort=mealId,ASC&sort=createdAt,DESC`;
        if (page) {
          endpoint += `&page=${page}`;
        }
        return axios
      ...
      getAnsweredQuestionsForCook(page) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/mealQuestions/answer?filter=answer||$notnull&sort=mealId,ASC&sort=createdAt,DESC`;
        if (page) {
          endpoint += `&page=${page}`;
        }
        return axios
      ...
      deleteMyAnswer(id) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/mealQuestions/answer/${id}`;
        return axios
          .delete(endpoint)
          .then((res) => {
            return Promise.resolve(res.data || {});
    ...
    tokens: {
      getTokens(page) {
        let endpoint = `${process.env.API_ORIGIN}/api/me/tokens`;
        if (page) {
          endpoint += `?page=${page}`;
        }
        return axios
    ...
    contactUs: {
      contactUs(data) {
        const endpoint = `${process.env.API_ORIGIN}/api/me/contact-us`;
        return axios
          .post(endpoint, data)
          .then((res) => {
            return Promise.resolve(res.data || {});
  ...
  payment: {
    createCustomer(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/me/subscriptions/create-customer`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    makePayment(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/me/subscriptions/make-payment`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    createSubscription(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/me/subscriptions/create-subscription`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    updateSubscription(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/me/subscriptions/update-subscription`;
      return axios
        .put(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    getSubscriptionById(id) {
      const endpoint = `${process.env.API_ORIGIN}/api/me/subscriptions/get-subscription-by-id/${id}`;
      return axios
        .get(endpoint)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    cancelSubscription(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/me/subscriptions/delete-subscription`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    getPaymentMethod(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/me/subscriptions/get-payment-method`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    updatePaymentMethod(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/me/subscriptions/update-payment-method`;
      return axios
        .put(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    createCheckoutSession(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/me/subscriptions/create-checkout-session`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    getCheckoutSession(id) {
      const endpoint = `${process.env.API_ORIGIN}/api/me/subscriptions/get-checkout-session/${id}`;
      return axios
        .get(endpoint)
        .then((res) => {
          return Promise.resolve(res.data || {});
  ...
  invitations: {
    generateInvitation(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/invitations/generate-invitation-link`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    reGenerateInvitation(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/invitations/re-generate-invitation-link`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    validateInvitation(invitationCode) {
      const endpoint = `${process.env.API_ORIGIN}/api/invitations/validate-invitation/${invitationCode}`;
      return axios
        .get(endpoint)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    validateAcceptedInvitation(invitationCode) {
      const endpoint = `${process.env.API_ORIGIN}/api/invitations/validate-accepted-invitation/${invitationCode}`;
      return axios
        .get(endpoint)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    getInvitedUser(email) {
      const endpoint = `${process.env.API_ORIGIN}/api/invitations/get-invited-user/${email}`;
      return axios
        .get(endpoint)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    sendInvitation(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/invitations/send-invitation`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    acceptAlreadyRegisteredInvitation(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/invitations/accept-already-registered-invitation`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
    ...
    rejectInvitation(data) {
      const endpoint = `${process.env.API_ORIGIN}/api/invitations/reject-invitation`;
      return axios
        .post(endpoint, data)
        .then((res) => {
          return Promise.resolve(res.data || {});
  ...
  ratings:{
    ...
    getRatingByUserId(userId) {
      const endpoint = `${process.env.API_ORIGIN}/api/ratings/get-rating-by-user-id/${userId}`;
      return axios
        .get(endpoint)
        .then((res) => {
          return Promise.resolve(res.data || {});
