<template>
  <div class="row">
    ...
    <div class="col-12 col-lg-10 mx-auto position-relative" v-if="!isBasketEmpty">
      ...
      />
      <nuxt-link :to="{ path: '/dashboard/shop/basket' }" class="shop-back d-inline-flex align-items-center">
    ...
    <div class="col-12 col-sm-8 col-md-10 col-lg-9 col-xl-8 mx-auto text-center" v-else>
      ...
      <div class="box-btn mt-5">
        <nuxt-link :to="{ path: '/dashboard/shop' }" class="btnGreenTransparent btnHugeSize btn100 hover-slide-left">
...
export default {
  name: "Checkout",
  components: { SvgIcon,ShippingInfoModal,EditBtn,PaymentMethodModal},
  data: () => ({
  ...
  computed: {
    ...
    completeAddress() {
     ...
     successURL(){
      return process.env.STRIPE_INFO.SHOP_SUCCESS_URL
    },
     cancelURL(){
      return process.env.STRIPE_INFO.SHOP_CANCEL_URL
    },
  },
  methods: {
    async prepareData() {
