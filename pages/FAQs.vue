<template>
  <div id="home-page">
    <Header activeItem="faqs" isGreenColor></Header>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 col-md-10 mx-auto text-center">
              <h1 class="title-size1 titleLightColor mb-4">FAQs</h1>
            </div>
          </div>
        </div>
        <HeroWave></HeroWave>
            ...
            <div class="col-xl-11 mx-auto">
              <div class="accordion" role="tablist">
                    ...
                    <div class="faq-text">
                      ...
                      <ul class="list-decimal">
                        ...
                        <li>
                          ...
                          <nuxt-link :to="{ path: '/dashboard/shop' }">Shop</nuxt-link>
                ...
                <div class="faq-box">
                  ...
                  >
                    <div class="faq-text">
                      ...
                      marking it URGENT in the subject line.
                    </div>
                  </b-collapse>
                </div>
                ...
                <div class="faq-box">
                  ...
                  >
                    <div class="faq-text">
                      Please review our <nuxt-link to="/food-safety">Food Safety FAQs</nuxt-link> page thoroughly.
                ...
                <div class="faq-box">
                  ...
                  >
                    <div class="faq-text">
                      ...
                      <a class="href-mailto" href="mailto:info@plentylane.com">info@plentylane.com</a>
                      and we’ll be happy to answer your other questions.
                    </div>
                  </b-collapse>
                </div>
              </div>
