          ...
          <div class="authorization-box-position position-relative">
            ...
            <b-form class="form" @submit.stop.prevent="onSubmit">
              <b-form-group>
                ...
                <small
                  ...
                  >Please enter valid email/username.</small
                >
                <small
                  class="text-danger d-flex mt-2 text-left"
            ...
            <div class="authorization-box-info">
              ...
              <p>
                ...
                <nuxt-link to="/forgot-password">Reset it here</nuxt-link>
              </p>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    isValidPassword(value) {
      ...
      return new RegExp(
        `^(?=.*\\d)(?=.*[A-Z]).{${process.env.PWD_MIN_LENGTH},}$`,
        "g"
      ).test(value);
    },
    resetError() {
      ...
      api.auth
        ...
        .then((response) => {
          if (response.accessToken) {
            this.$cookies.set("plAccessToken", response.accessToken);
          }
