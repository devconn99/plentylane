          ...
          <div class="authorization-box-position position-relative">
            ...
            <b-form class="form" @submit.stop.prevent="onSubmit">
              ...
              <b-form-group>
                ...
                ></b-form-input>
                <small class="text-notification d-flex mt-2 text-left">We won't share your contact information.</small>
            ...
            <div class="authorization-box-info">
              <div>
                <p>
                  ...
                  <nuxt-link to="/privacy">Privacy</nuxt-link> and
                  <nuxt-link to="/terms">Terms policies</nuxt-link>.
                </p>
                <p>
