      ...
      <div class="w-100">
        <b-collapse class="rest-filters-wrapper mt-2" id="collapse-rest-filters" v-model="restFiltersVisible">
          ...
          <b-form-group label="Available servings" class="available-servings-form-group">
            ...
            >
              Minimum number of available servings is {{availableServingsMin}}.
            </small>
            <small
              class="text-danger d-flex mt-2 text-left"
              v-if="!$v.form.availableServings.maxValue"
            >
              Maximum number of available servings is {{availableServingsMax}}.
            </small>
          </b-form-group>
...
export default {
  ...
  data: () => ({
    ...
    isCompactView: false,
    isMobileView: false,
    availableServingsMin: process.env.SEARCH.AVAILABLE_SERVINGS_MIN,
    availableServingsMax: process.env.SEARCH.AVAILABLE_SERVINGS_MAX
  }),
  validations: {
    form: {
      name: {},
      ...
      viewType: {},
      availableServings: {
        minValue: minValue(process.env.SEARCH.AVAILABLE_SERVINGS_MIN),
        maxValue: maxValue(process.env.SEARCH.AVAILABLE_SERVINGS_MAX)
      },
      dietaryNotes: {}
    }
  },
